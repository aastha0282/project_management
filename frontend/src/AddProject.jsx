  ...
  return (
    <div className='d-flex flex-column align-items-center pt-4'>
			...
			<div className="col-12">
					<label htmlFor="inputName" className="form-label">Project Name</label>
					<input type="text" className="form-control" id="inputName" placeholder='Enter Project Name' autoComplete='off'
